...
class Avalanche:
    ...
    def step(self, step_time, saving_lattice=False):
        ...
        curr[1:-1, 1:-1] = curv[1:-1, 1:-1] - 1 / 4 * (curv[1:-1, 0:-2] + curv[1:-1, 2:] +
                                                             curv[0:-2, 1:-1] + curv[2:, 1:-1])
                ...
                if i == 0 or i ==self.n-1 or j == 0 or j == self.n-1:
                    ...
                    if curr[i, j] > Zc:
                        ...
                        if new_energy_dissipated < 0:
                            pass
                            # print('negative node energy')

                        elif new_energy_dissipated >= 0:
